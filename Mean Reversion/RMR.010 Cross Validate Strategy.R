...
#' 
#' Value  
#' Returns a list containing the intercept and hedge ratio calculated from a rolling regression over the test set 
#' as well as the spread and z-score of the spread.  
...
#' return_pair() and the mean is taken.  
#' 
#' Arguments  
#' train: A dataframe generated by prepare_data() that represents the training set for the coin pair.  
#' test: A dataframe generated by prepare_data() that represents the test set for the coin pair.  
