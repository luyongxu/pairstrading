...
#' # 13. Calculate Strategy Return
#' Description  
#' Calculates the return of the overall strategy over the test set.  
#' 
#' Arguments  
...
#' # 13. Backtest Strategy Full Function 
#' Description  
...
backtest_strategy_full <- function(pricing_data, params) { 
  ...
  for (cutoff_date in cutoff_dates) {  
    ...
    # Error handling if no coin pairs are selected 
